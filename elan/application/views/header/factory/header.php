...
<div   id="loaderDisplay"></div>
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url('factory-dashboard'); ?>" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('uploads/'.(!empty($adminData['profile']) ? $adminData['profile'] :'logo.png')); ?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('factory-update-profile'); ?>" class="btn btn-default btn-flat">Update</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url('factory-logout-account'); ?>" class="btn btn-default btn-flat">Logout</a>
                </div>
              </li>
            </ul>
          </li>
