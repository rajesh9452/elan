<footer class="main-footer">
    <strong>Copyright &copy; 2018-2019 <a href="#"><?= ELAN?></a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Sparkline -->
<script src="<?php echo base_url('theme/'); ?>bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('theme/'); ?>bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
