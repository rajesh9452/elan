<div class="content-wrapper">
  <style type="text/css">span.mobileVerify {color: #14c7e4eb;padding-left: 8px;}span.emailVerify {color: #14c7e4eb;padding-left: 8px;}span.activateShow a {font-size: 19px;color: green;}span.deleteShow a {font-size: 19px;color: red;}img.img-thumbnail {width: 225px;}</style>
    ...
    <section class="content-header">
      <h1>
        Manage
        <small><?php echo (!empty($result) ? 'Update Company' : 'Add New Company'); ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('admin-dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"><?php echo (!empty($result) ? 'Update Company' : 'Add New Company'); ?></a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo (!empty($result) ? 'Update Company' : 'Add New Company'); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <!-- /.box-body -->
              <form class="form-horizontal" method="post" action="<?php echo base_url('register-new-company'); ?>" onsubmit="return validate()">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="number" placeholder="Please enter mobile number"  value="<?php echo  (!empty(set_value('mobile')) ? set_value('mobile') : (!empty($result['mobile']) ? $result['mobile'] : ''  ) ); ?>">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <textarea class="form-control" placeholder="Please enter company addressr" name="address" ><?php echo  (!empty($result['address']) ? $result['address'] : ''  ); ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="email">Pincode:</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="pincode" placeholder="Please enter Pincode number"  value="<?php echo (!empty($result['pincode']) ? $result['pincode'] : ''  ); ?>">
