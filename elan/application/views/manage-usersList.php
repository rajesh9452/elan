<div class="content-wrapper">
                ...
                <tbody id="changeStatusID">   
                 <?php
                   ...
                   foreach($result as $list):
                    echo '<tr> 
                        <td>'.$count.'</td>
                        <td><a href="'.base_url('add-new-users/'.base64_encode($list->id)).'">'.ucfirst($list->name).'</a></td>
  ...
  <script type="text/javascript">
     function deleteUsers(get) {
        ...
        if (r == true) {
          window.location.href = '<?php echo base_url('user-account-delete'); ?>/'+argument;
        }
    }
    function ActivateUsers(get) {
        ...
        if (r == true) {
          window.location.href = '<?php echo base_url('activate-userAccount'); ?>/'+argument;
        }
    }
    function deactivateUsers(get) {
        ...
        if (r == true) {
          window.location.href = '<?php echo base_url('deactivate-userAccount'); ?>/'+argument;
        }
    }
  </script>