<div class="content-wrapper">
  <style type="text/css">span.mobileVerify {color: #14c7e4eb;padding-left: 8px;}span.emailVerify {color: #14c7e4eb;padding-left: 8px;}span#addNew {
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('manage-company-list'); ?>">Manage Company</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-body -->
            <a href="<?php echo base_url('add-new-company'); ?>"> <span class="btn btn-info" id="addNew"><i class="fa fa-plus" aria-hidden="true"></i></span></a>
                ...
                <tbody id="changeStatusID">   
                 <?php
                   ...
                   foreach($result as $list):
                    echo '<tr> 
                        <td>'.$count.'</td>
                        <td><a href="'.base_url('add-new-company/'.base64_encode($list->id)).'">'.ucfirst($list->name).'</a></td>
                        <td>'.$list->mobile.'</td>
                        <td>'.$list->email.'</td>
  ...
  <script type="text/javascript">
     function deleteUsers(get) {
        ...
        if (r == true) {
          window.location.href = '<?php echo base_url('company-account-delete'); ?>/'+argument;
        }
    }
    function ActivateUsers(get) {
        ...
        if (r == true) {
          window.location.href = '<?php echo base_url('activate-companyAccount'); ?>/'+argument;
        }
    }
    function deactivateUsers(get) {
        ...
        if (r == true) {
          window.location.href = '<?php echo base_url('deactivate-companyAccount'); ?>/'+argument;
        }
    }
  </script>