...
class ProjectGalleryListDelete extends CI_Controller{
    ...
    public function get_Gallery()
    {
      ...
      $check_request_keys = array('type','gallery_id','project_id');
      ...
      if($resultJson ==OK)
      {           
        $this->request->DeleteProjectGallery($requestData[APP_NAME]);
      }
      else{
